...
The forward trajectory enriches the conversational layer with tools rather than more modalities. Evaluation will strengthen through the online protocol in Section~\ref{sec:online-protocol}; personalisation will strengthen through the multi-intent representation in Section~\ref{sec:multi-intent}.
