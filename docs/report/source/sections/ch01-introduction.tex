...
\begin{enumerate}
    ...
    \item A typed client SDK contract (\texttt{@sprout/gemini-proxy-sdk}) that hides WebSocket reconnection, JWT refresh, and audio framing from the rest of the frontend.
